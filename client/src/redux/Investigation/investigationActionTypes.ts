...
interface SetIsContactInvestigationVerifiedAbroad {
    type: typeof SET_IS_CONTACT_INVESTIGATION_VERIFIED_ABROAD,
...
interface SetInvestigationInfoChanged {
    type: typeof SET_INVESTIGATION_INFO_CHANGED,
