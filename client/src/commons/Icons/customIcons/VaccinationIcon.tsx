...
import useStyles from 'commons/Icons/customIcons/customIconStyles';

const VaccinationIcon = () => {
    const classes = useStyles();
    return (
        <SvgIcon viewBox='0 0 15 15' className={classes.box}>
            <svg aria-hidden='true' focusable='false' data-prefix='fas' data-icon='syringe' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
