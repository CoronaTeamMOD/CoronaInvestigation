...
import { alphaNumericSpecialCharsErrorMessage, max15LengthNumErrorMessage, max9LengthIdErrorMessage, numericErrorMessage } from 'commons/Schema/messages';
...
const IdentificationTextField = (props : Props) => {
    ...
    const schema = props.isId 
        ...
        : yup.string().matches(PASSPORT_DASH_REGEX, alphaNumericSpecialCharsErrorMessage).max(15, max15LengthNumErrorMessage);
