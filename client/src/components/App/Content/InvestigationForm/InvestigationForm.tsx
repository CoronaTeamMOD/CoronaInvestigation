...
const InvestigationForm: React.FC = (): JSX.Element => {
    ...
    const { currentTab, setCurrentTab, confirmFinishInvestigation, handleSwitchTab } = useInvestigationForm({ clinicalDetailsVariables, personalInfoData, exposuresAndFlightsVariables, setPersonalInfoData  });
