...
const isolatioDataSchema = (validationDate: Date, ifNeedIsoaltion: boolean = true) => {
    return  ifNeedIsoaltion ? {
...
const ClinicalDetailsSchema = (validationDate: Date, Gender: string, ifNeedIsoaltion: boolean = true) => {
    return yup.object().shape({
        ...isolatioDataSchema(validationDate,ifNeedIsoaltion),
