...
const schema = yup.object().shape({
    [PersonalInfoDataContextFields.PHONE_NUMBER]: yup.string().nullable().required(requiredText).matches(/^(0(?:[23489]|5[0-689]|7[2346789])(?![01])(\d{7}))$/,numberValidationText),
    [PersonalInfoDataContextFields.ADDITIONAL_PHONE_NUMBER]: yup.string().nullable().matches(/^(0(?:[23489]|5[0-689]|7[2346789])(?![01])(\d{7}))|^$/,numberValidationText),
    [PersonalInfoDataContextFields.CONTACT_PHONE_NUMBER]: yup.string().nullable().required(requiredText).matches(/^(0(?:[23489]|5[0-689]|7[2346789])(?![01])(\d{7}))$/,numberValidationText),
