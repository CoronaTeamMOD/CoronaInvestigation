    ...
    describe('getDatesToInvestigate tests:', () => {
        ...
        describe('symptomatic investigated person tests:', () => {
            it('get dates when symptoms start date is available', async () => {
                ...
                expect(receivedDates).toEqual(eachDayOfInterval({start: subDays(symptomsStartDate, 4), end: endInvestigationDate}));
            })
            ...
            it('get dates when symptoms start is not available', async () => {
                ...
                expect(receivedDates).toEqual(eachDayOfInterval({start: subDays(endInvestigationDate, 10), end: endInvestigationDate}));
            });
        });
        ...
        describe('asymptomatic investigated person tests:', () => {
            it('get dates when the investigated person is asymptomatic', async () => {
                ...
                expect(receivedDates).toEqual(eachDayOfInterval({start: subDays(endInvestigationDate, 7), end: endInvestigationDate}));
            });
        });
