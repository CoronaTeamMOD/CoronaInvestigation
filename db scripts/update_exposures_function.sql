...
begin
	...
	if exposures is not null and exposures::TEXT != '[]' then
		...
		if exposure_id is null then
			...
			INSERT INTO public.exposure(investigation_id, was_confirmed_exposure, exposure_source, 
				...
				VALUES(investigationId, wasConfirmedExposure, exposureSource, wasAbroad,
				...
				SET investigation_id=investigationId, was_confirmed_exposure=wasConfirmedExposure,
