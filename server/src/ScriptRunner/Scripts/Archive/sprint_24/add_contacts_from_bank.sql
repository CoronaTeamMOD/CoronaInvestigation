...
begin 
	...
	loop
		...
		select trim(nullif((contact->'creationSource')::text,'null'),'"')::int4 into creationSource;
	   
		INSERT INTO public.contacted_person
			(person_info, contact_event,extra_info, contact_type, creation_source)
			VALUES(personId, contact_event_id,extraInfo, contactType,creationSource);
