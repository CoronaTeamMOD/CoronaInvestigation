-- FUNCTION: public.update_investigator_by_group_id(character varying, uuid[], integer, character varying, boolean)

-- DROP FUNCTION public.update_investigator_by_group_id(character varying, uuid[], integer, character varying, boolean);
