-- FUNCTION: public.ordered_investigations(integer, character varying)

-- DROP FUNCTION public.ordered_investigations(integer, character varying);
...
on investigation.creator = u.id
where u.investigation_group = county
order by
...
DROP FUNCTION IF EXISTS  public.ordered_investigations(
	order_by character varying);
