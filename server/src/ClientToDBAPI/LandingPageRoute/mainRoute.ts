...
import { GET_ALL_INVESTIGATION_STATUS, GROUP_INVESTIGATIONS, USER_INVESTIGATIONS, GET_INVESTIGATION_STATISTICS, GET_UNUSUAL_INVESTIGATIONS_COUNT, GET_ALL_INVESTIGATION_SUB_STATUS } from '../../DBService/LandingPage/Query';
