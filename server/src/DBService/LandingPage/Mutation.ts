...
mutation createAdminMessage($id: Int!, $message: String!, $desks_id: [Int]!, $admin_id: String!) {
  createAdminMessage(
    input: {adminMessage: {id: $id, message: $message, desksId: $desks_id, adminId: $admin_id}}
  ) {
    clientMutationId
  }
}
