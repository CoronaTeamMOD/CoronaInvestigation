...
mutation updateInvestigationByEpidemiologyNumber ($epidemiologyNumber: Int!, $hospital: String!, $hospitalizationEndTime: Datetime!, $hospitalizationStartTime: Datetime!, $investigatedPatientId: Int!, $isIsolationProblem: Boolean!, $isIsolationProblemMoreInfo: String!, $isolationEndTime: Datetime!, $isolationStartTime: Datetime!, $symptomsStartTime: Datetime!, $isolationAddress: Int!, $isInIsolation: Boolean!, $doesHaveSymptoms: Boolean!, $wasHospitalized: Boolean!) {
