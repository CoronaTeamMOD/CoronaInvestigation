...
mutation updateInvestigatedPersonPersonalInfo($id: Int!, $hmo: String, $otherOccupationExtraInfo: String, $occupation: String, $patientContactPhoneNumber: String, $subOccupation: String, $patientContactInfo: String, $additionalPhoneNumber: String, $role: Int, $educationGrade: String, $educationClassNumber: Int) {
